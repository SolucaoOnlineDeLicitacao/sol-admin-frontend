...
<template lang="pug">
  .root
    ...
    .container.group
      form.card(ref="form", method="post", @keydown.enter.prevent="addGroupItem", @submit.prevent="submit")
  ...
  export default {
    ...
    methods: {
      submit() {
        ...
        this.$http.post('/administrator/covenants/' + this.covenantId + '/groups', formData)
          .then((response) => {
